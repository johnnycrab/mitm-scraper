...
var Blacklist, Handlebars, PageTransformer, Templates, app, cheerio, express, fs, hbTemplates, incSequenceNumber, io, precompileTemplates, redis, redisClient, redisClient2, sequenceNumber, server, subterfuge_css_loc, subterfuge_image_loc;
...
PageTransformer = (function() {
  ...
  PageTransformer.prototype.save = function() {
    ...
    if (this.coverHtml) {
      redisClient2.publish(publishName + '_cover', this.coverHtml, redis.print);
    }
