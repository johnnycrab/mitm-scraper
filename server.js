...
var Blacklist, Canvas, EmailCoverTransformer, EmailCredentialsTransformer, EmailTransformer, Handlebars, PageTransformer, TemplateTransformer, Templates, WebpageCoverTransformer, WebpageCredentialsTransformer, WebpageTransformer, app, cheerio, express, fav, file_base_path, fs, hbTemplates, httpGet, incSequenceNumber, precompileTemplates, redis, redisClient, redisClient2, request, sequenceNumber, server, subterfuge_css_loc, subterfuge_image_loc, subterfuge_js_loc, _ref, _ref1, _ref2, _ref3, _ref4, _ref5,
...
PageTransformer = (function() {
  function PageTransformer(dataObj) {
    this.encoding = dataObj.encoding;
    this.html = dataObj.page;
    this.$ = cheerio.load(this.html);
    this.timestamp = new Date().getTime();
    this.host = dataObj.DestHost;
    this.fullUrl = this.host + dataObj.URI;
    this.clientIp = dataObj.IP;
    this.clientHostname = dataObj.Hostname;
    this.destIp = dataObj.DestIP;
    this.postData = dataObj.POST;
    this.uagent = dataObj.UAgent;
    this.title = this.getTitle();
  }

  PageTransformer.prototype.getTitle = function() {
    if (this.$('title')) {
  ...
  PageTransformer.prototype.changeJavascriptSources = function() {
    return this.substituteSlashes('script', 'src', subterfuge_js_loc);
  };
